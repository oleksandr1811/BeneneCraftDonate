<?php
/* Smarty version 3.1.30, created on 2021-01-16 21:46:03
  from "C:\Users\whita\Desktop\OSPanel\domains\dfdsgfadgfdgsds.ru\templates\main.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6003346b7e9074_81918234',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'aca06cf1d76f26440eb4bd9064dd1a9afd6ef386' => 
    array (
      0 => 'C:\\Users\\whita\\Desktop\\OSPanel\\domains\\dfdsgfadgfdgsds.ru\\templates\\main.html',
      1 => 1610822759,
      2 => 'file',
    ),
  ),
...
function content_6003346b7e9074_81918234 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="sidenav" id="sidenav_mobile">
    ...
    <a href="https://vk.com/topic-131589419_38716560">Правила</a>
    <a href="how/index.htm">Как купить донат?</a>
    <a href="https://vk.com/topic-131589419_35488942">Описание доната</a>
    <a href="https://vk.me/mased_world">Контакты</a>
</div>
<header>
        ...
        <div class="container">
            <div class="menu d-flex align-items-center justify-content-between">
                ...
                <span class="d-none d-lg-inline d-md-none" style="text-align: center;">
                    <a href="https://vk.com/topic-131589419_38716560" style="color: white;"><img src="assets/rules.svg">Правила</a>
					<a href="how/index.htm" style="color: white;"><img src="assets/donate.svg">Как купить донат?</a>
                    <a href="https://vk.com/topic-131589419_35488942" style="color: white;"><img src="assets/opis.svg">Описание доната</a>
                    <a href="//vk.me/mased_world" style="color: white;"><img src="assets/contact.svg">Контакты</a>
                    <br>
                </span>
...
<div class="container lasts">
    ...
    <div class="users row">
        <div class="user col-4 col-lg-1">
            ...
            <div class="name">Asura</div>
            <div class="privilege">Владелец</div>
        </div>
        <div class="user col-4 col-lg-1">
            <img src="assets/skin.png">
            <div class="name">Hotl1ne</div>
            <div class="privilege">Владелец</div>
        </div>
        <div class="user col-4 col-lg-1">
            <img src="assets/skin.png">
            <div class="name">DadDAda</div>
            <div class="privilege">Император</div>
        </div>
        <div class="user d-none col-lg-1">
            <img src="assets/skin.png">
            <div class="name">Asura</div>
            <div class="privilege">Креатив</div>
        </div>
        <div class="user col-1 d-none d-lg-flex">
            <img src="assets/skin.png">
            <div class="name">DaryaNyash</div>
            <div class="privilege">5 ключей от кейса</div>
        </div>
        <div class="user col-1 d-none d-lg-flex">
            <img src="assets/skin.png">
            <div class="name">Tubik_</div>
            <div class="privilege">Владелец</div>
        </div>
        <div class="user col-1 d-none d-lg-flex">
            <img src="assets/skin.png">
            <div class="name">Asura</div>
            <div class="privilege">Легенда</div>
        </div>
        <div class="user col-1 d-none d-lg-flex">
            <img src="assets/skin.png">
            <div class="name">Hotl1ne</div>
            <div class="privilege">Оператор</div>
        </div>
        <div class="user col-1 d-none d-lg-flex">
            <img src="assets/skin.png">
            <div class="name">Anime1Love</div>
            <div class="privilege">Владелец</div>
        </div>
        <div class="user col-1 d-none d-lg-flex">
            <img src="assets/skin.png">
            <div class="name">Asura</div>
            <div class="privilege">Вип</div>
        </div>
        <div class="user col-1 d-none d-lg-flex">
            <img src="assets/skin.png">
            <div class="name">Hotl1ne</div>
            <div class="privilege">Премиум</div>
        </div>
        <div class="user col-1 d-none d-lg-flex">
            <img src="assets/skin.png">
            <div class="name">Union</div>
            <div class="privilege">Лорд</div>
        </div>
    </div>
